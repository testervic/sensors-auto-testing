...
public class DeleteProductPictureLink extends BaseTestMethod {
    ...
    public void deleteProductExhibitLink() throws YamlException, FileNotFoundException, InterruptedException {
        ...
        PublicPage deleteProductExhibitLink = new PublicPage(this.driver, "/sq/ProductManagement/DeleteProductPictureLink.yaml");
