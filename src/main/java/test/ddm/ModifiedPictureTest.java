...
public class ModifiedPictureTest {
    ...
    @Test(priority = 2)
    public void productList() throws YamlException, FileNotFoundException, InterruptedException {
        PublicPage publicPage = new PublicPage(this.driver, "/ddm/ModifiedPicture.yaml");
